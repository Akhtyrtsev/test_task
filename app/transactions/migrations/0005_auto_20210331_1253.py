...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('transactions', '0004_auto_20210331_1248'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('Purchase', 'Purchase'), ('Refund', 'Refund'), ('Withdrawal', 'Withdrawal')], default='Purchase', max_length=64)),
